...
export const Formations: CollectionConfig = {
  ...
  fields: [
    ...
    },
    {
      ...
      type: "text",
      required: true,
      admin: { description: "Libellé long, ex. 35 heures — 5 journées" },
    },
    {
      name: "dureeHeures",
      type: "number",
      label: "Nb heures",
      min: 1,
      admin: { description: "Nombre d’heures (affiché sur les cards)" },
    },
    {
      name: "dureeJours",
      type: "number",
      label: "Nb jours",
      min: 1,
      admin: { description: "Nombre de jours / journées (affiché sur les cards)" },
    },
    {
      name: "format",
      type: "text",
