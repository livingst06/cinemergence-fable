...
export function SiteNoticeBanner({ nda }: SiteNoticeBannerProps) {
  return (
    <div
      ...
      role="note"
    >
      <p className="container-page flex min-h-9 items-center justify-start py-2 text-left font-sans text-[11px] font-medium normal-case leading-snug tracking-normal md:min-h-11 md:text-sm">
        Cinémergence est un organisme de formation professionnelle déclaré sous le numéro NDA{" "}
        {nda}, enregistré auprès de la DREETS Île-de-France.
      </p>
    </div>
  );
}
