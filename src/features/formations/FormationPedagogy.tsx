        ...
        return (
          <li key={item} className="card-stage flex items-start gap-3 p-5">
            ...
            <div className="min-w-0">
              ...
              {detail && (
                <p className="mt-1.5 text-justify text-sm leading-relaxed text-muted-text">{detail}</p>
              )}
            </div>
          </li>
        );
            ...
            {cleanMoyens.map((m) => (
              ...
              >
                <span
                  ...
                  aria-hidden
                />
                <p className="pl-3 text-justify text-sm leading-relaxed text-cream/85 md:pl-4 md:text-[0.95rem] md:leading-7">
                  {m}
                </p>
              </div>
            ))}
      ...
      {encadrement && (
        <div>
          ...
          <div className="rounded-xl border border-or/20 bg-or/[0.06] px-5 py-4 md:px-6 md:py-5">
            <p className="text-justify text-sm leading-relaxed text-cream/90 md:text-[0.95rem] md:leading-7">
              {encadrement}
            </p>
          </div>
        </div>
...
export function FormationProse({ children }: ProseProps) {
  return (
    <div className="space-y-4 text-justify text-base leading-relaxed text-muted-text md:leading-7">
      {children}
    </div>
  );
}
