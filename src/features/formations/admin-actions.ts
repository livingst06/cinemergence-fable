...
const formationAdminSchema = z.object({
  ...
  tarifEuros: z.number().int().min(1).optional().nullable(),
...
function placeholdersFromEssentials(data: FormationAdminInput) {
  ...
  return {
    ...
    tarifEuros: typeof data.tarifEuros === "number" ? data.tarifEuros : null,
  ...
  try {
    ...
    await payload.update({
      ...
      data: {
        ...
        tarifEuros:
          typeof parsed.data.tarifEuros === "number" ? parsed.data.tarifEuros : null,
